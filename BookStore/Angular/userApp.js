    ...
    app.factory('userFactory', function ($http, $window, $rootScope, $timeout) {
        ...
        userFactory.editPerson = function (person) {
            ...
            .success(function (data) {
                ...
                //else {
                //    if (userFactory.people.length != 0) {
                //        //find the person using id and update it
                //        for (var i in userFactory.people) {
                //            if (userFactory.people[i].Id == person.Id) {
                //                userFactory.people[i] = person;
                //            }
                //        }
                //    }
                //    else {
                    ...
                    return $http.post('/Order/AddOrder', cart)
                        .success(function (response) {
                            ...
                            if (response.status === "Success") {
                                ...
                                userFactory.message = "Something went wrong when saving the new book, try again.";
                                console.log(response.data);
                            }
                            else {
                                // model from MVC isn't valid set the error message/messages
